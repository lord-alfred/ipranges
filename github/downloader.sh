...
jq 'del(.["ssh_keys", "ssh_key_fingerprints", "verifiable_password_authentication", "ssh_key_fingerprints", "domains", "commit_signing_keys"]) | .[] | .[]' -r /tmp/github.json > /tmp/github-all.txt
